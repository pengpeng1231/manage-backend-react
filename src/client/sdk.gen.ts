...
import type { CreateUserData, CreateUserResponses, EditUserData, EditUserResponses, DelMenuData, DelMenuResponses, CreateMenuData, CreateMenuResponses, EditMenuData, EditMenuResponses, RegisterData, RegisterResponses, LoginData, LoginResponses, LoginOrRegisterData, LoginOrRegisterResponses, CheckAuthData, CheckAuthResponses, DeleteUserData, DeleteUserResponses, GetUserByIdData, GetUserByIdResponses, GetMenusData, GetMenusResponses } from './types.gen';
...
export const getMenus = <ThrowOnError extends boolean = false>(options: Options<GetMenusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMenusResponses, unknown, ThrowOnError>({
        url: '/api/menu/list',
        ...options
    });
};